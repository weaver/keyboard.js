...
define(['exports'], function(exports) {
  ...
  Keyboard.prototype.bind = function(type, el) {
    ...
    bind(el, type, function(ev) {
      var point = name(ev), fn = keys[point];
      // console.log('handle?', ev.type, point, ev, 'need:', modifiers(ev, point), keys);
      fn = fn && fn[modifiers(ev, point)];
      return fn ? fn(ev) : true;
    });
  ...
  function parseCode(name) {
    ...
    return new Key(probe.mask, probe.code);
  }
